...
public class PreIncreament extends Element<Integer> implements LowerDockable<Integer>{

	IntDock dock1;

	public PreIncreament(){
		dock1 = new IntDock(DockLocation.PREINCREAMENT);
		view = new LeftUnaryOperatorView<Integer>(dock1,"++",this,"inokwidza zvakatakurwa yozodzosa zvavemo");
	}
