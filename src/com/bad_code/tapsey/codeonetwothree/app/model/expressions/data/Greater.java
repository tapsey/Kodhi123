...
public class Greater extends  Element<Boolean> implements LowerDockable<Boolean>{

	Boolean returnValue;
	DoubleDock dock1, dock2;
	
	public Greater(){
		dock1 = new DoubleDock(DockLocation.GREATER);
		dock2 = new DoubleDock(DockLocation.GREATER);
		view = new BinaryOperatorView<Double, Double>("mukuru kuna", Color.RED,
	...
	public boolean isDockablehere(DataType dockDataType,
		...
		if ( dockDataType == DataType.BOOLEAN) {
			...
			Window.writeError(" mukuru haakwanise kugadzikwa pano");
