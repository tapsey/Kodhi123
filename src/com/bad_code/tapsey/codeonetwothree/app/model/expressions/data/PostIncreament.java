...
public class PostIncreament extends Element<Integer> implements LowerDockable<Integer>{
	
	IntDock dock1;
	public PostIncreament(){

		dock1 = new IntDock(DockLocation.POSTINCREAMENT);
		view = new RightUnaryOperatorView< Integer>(dock1,"++",this,"inowedzera zvakatakurwa yambodzosa zvirimo nechekare");
	}
