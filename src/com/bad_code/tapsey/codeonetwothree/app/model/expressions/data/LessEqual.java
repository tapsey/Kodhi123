...
public class LessEqual  extends Element<Boolean> implements LowerDockable<Boolean>{
	Boolean returnValue;
	DoubleDock dock1, dock2;
	
	public LessEqual(){
		dock1 = new DoubleDock(DockLocation.LESSOREQUAL);
		dock2 = new DoubleDock(DockLocation.LESSOREQUAL);
		view = new BinaryOperatorView<Double, Double>("kudiki kana kuti akaenzana", Color.RED,
	...
	public boolean isDockablehere(DataType dockDataType,
		...
		if ( dockDataType == DataType.BOOLEAN) {
			...
			Window.writeError(" mudiki kana kuti vakaenza haakwanise kugadzikwa pano");
